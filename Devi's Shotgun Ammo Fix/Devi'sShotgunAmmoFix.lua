...
-- Flechette
self.parts.wpn_fps_upg_a_piercing.stats = {value = 5, total_ammo_mod = 0, damage = 100, spread = -2, moving_spread = 0, recoil = 5}
...
-- Dragon's Breath
self.parts.wpn_fps_upg_a_dragons_breath.stats = {value = 5, total_ammo_mod = 0, damage = 75, spread = -6, moving_spread = 0, recoil = -3}
...
-- 000 Buckshot
self.parts.wpn_fps_upg_a_custom.stats = {value = 5, total_ammo_mod = 6, damage = 150, spread = -2, moving_spread = 0, recoil = -1}
...
--Heavy Crossbow
self.parts.wpn_fps_bow_arblast_m_standard.custom_stats = {ignore_statistic = true, armor_piercing_add = 1, can_shoot_through_shield = true}
end
--end